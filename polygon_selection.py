...
def return_markers_in_polygon(x, y, x_variable, y_variable, gate_name, colormap):
    fig, ax = plt.subplots(figsize=(6,6))
    z = density_scatter(x,y)
    pts = ax.scatter(x, y, c=z, cmap=colormap, s=5)
    ...
    gated_data.append('polygon_gate')
    gated_data = gated_data[1:]
